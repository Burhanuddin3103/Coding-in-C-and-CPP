...
void sort_ft(int arr1[],int arr2[],int arr3[],int arr4[],int arr5[],int n)
{
    int i,j,temp;
    for(i=0;i<n-1;i++)
    {
...
void sort_pr(int arr1[],int arr2[],int arr3[],int arr4[],int arr5[],int n)
{
    int i,j,temp;
    for(i=0;i<n-1;i++)
    {
...
void print(int n)
{
    ...
    sort_ft(g.AT,g.PR,g.BT,g.pn,g.FT,n);
    sort_pr(g.PR,g.BT,g.pn,g.AT,g.FT,n);
    m = n;
    for(i=1;i<n;i++)
    {
        if(g.PR[i] < g.PR[i-1])
